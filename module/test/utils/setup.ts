...
export const getWebAuthnModule = async () => {
  const ModuleDeployment = await deployments.get('WebAuthnValidator')
  return await ethers.getContractAt('WebAuthnValidator', ModuleDeployment.address)
}
